# 2D Surgical Planning Mode

## Introduction
2D Surgical Planning mode allows you to:
...
The 2D Surgical Planner mode includes comprehensive screw management capabilities for pedicle screw surgery planning:
...
Access the 2D Surgical Planner mode via the `/planner2d` route:
```
http://localhost:3000/planner2d?StudyInstanceUIDs=<study-id>
```
